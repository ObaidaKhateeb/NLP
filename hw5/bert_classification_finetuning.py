...
def main():
    ...
    training_args = TrainingArguments(output_dir= '/tmp', do_eval = False, evaluation_strategy = "no", learning_rate= 1.5e-5, per_device_train_batch_size = 8, num_train_epochs = 3, weight_decay = 0.005)
